...
import 'package:ridewave/authentication/forgotPassword.dart';
import 'package:ridewave/authentication/signup_screen2.dart';
      ...
      usersRef.once().then((snap) {
        if (snap.snapshot.value != null) {
          if ((snap.snapshot.value as Map)["blockStatus"] == "no") {
            ...
            cMethods.displaySnackBar(
                "you are blocked. Contact admin: nabilahamnda@gmail.com", context);
          }
        } else {
          FirebaseAuth.instance.signOut();
          cMethods.displaySnackBar(
