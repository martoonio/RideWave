...
class CommonMethods {
  ...
  static Future<String> convertGeoGraphicCoOrdinatesIntoHumanReadableAddress(
    ...
    if (responseFromAPI != "error") {
      ...
      Provider.of<AppInfo>(context, listen: false).updateDropOffLocation(model);
    }
  ...
  calculateFareAmount(DirectionDetails directionDetails) {
    double distancePerKmAmount = 1;
    double durationPerMinuteAmount = 1;
    double baseFareAmount = 2000;
    ...
    double totalDurationSpendFareAmount =
        (directionDetails.durationValueDigits!) * durationPerMinuteAmount;
